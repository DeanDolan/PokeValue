class ProductController < ApplicationController
  ...
  # Uses the set logo image at the top of the product page.
  ...
  # Builds the same product-value SKU used by product value records.
  ...
  # Finds any edited value for this product.
